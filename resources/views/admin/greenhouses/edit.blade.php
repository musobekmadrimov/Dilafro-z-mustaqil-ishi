...
@section('content')
    <div class="row" style="padding-left: 15px">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-0" data-aos="fade-down" data-aos-delay="200" data-aos-duration="500">
                        <div class="card-body">
                            <form action="{{ route('greenhouses.update', $greenhouse->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-6 d-flex align-items-end">
                                        <div class="input-material-group mb-3 w-100">
                                            <input type="text" id="name" name="name" class="input-material" value="{{ $greenhouse->name }}">
                                            <label class="label-material" for="name">Issiqxona nomi</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 d-flex align-items-end">
                                        <div class="input-material-group mb-3 w-100">
                                            <input type="number" id="price" name="price" class="input-material" value="{{ $greenhouse->price }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-material-group mb-3">
                                            ...
                                            <textarea id="description" name="description" class="input-material pt-3" style="outline: none" rows="5">{{  $greenhouse->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <script>
        ...
        //     $('#previewImg').attr('src', `localhost/storage/images/{{ $greenhouse->image }}`);
        // }
        // previewLastImage()
    </script>
@endsection
